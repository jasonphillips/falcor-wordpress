...
var AuthorsById = (function (_FetchById) {
  _inherits(AuthorsById, _FetchById);

  function AuthorsById() {
    _classCallCheck(this, AuthorsById);

    _get(Object.getPrototypeOf(AuthorsById.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(AuthorsById, [{
    key: 'getIdQuery',
